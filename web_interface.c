...
static const char html_page[] = 
    ...
    "<select id='type' onchange='updateParamLabel()'>"
    ...
    "<option value='6'>Remap Address</option>"
    "</select>"
    "</div>"
    "<div class='form-group'>"
    "<label id='paramLabel'>Parameter:</label><input type='number' id='param' value='0'>"
    "</div>"
    ...
    "if(type=='6'){label.textContent='Remap Address:';}else{label.textContent='Parameter:';}"
    "}"
    "function addRule(){"
